...
describe('Simple Transform', function() {
  ...
  describe('v', function() {
    ...
    it("should return all vertices", function(){
        ...
        expect(result).to.have.deep.property('results[0].name', 'marko');
    });
    ...
    // it("should NOT return a value if id not a vertex id", function(){
    //     expect(g.v(7).emit()).to.throw(ReferenceError);
    // });
    ...
    it("should return id 1 & 4", function(){
        ...
        expect(result).to.have.deep.property('results[0].name', 'marko');
        expect(result).to.have.deep.property('results[1].name', 'josh');
    });

    it("should return lang=java", function(){
        var result = g.v({'lang':{$eq:'java'}}).emit();
        expect(result.results.length).to.equal(2);
        expect(result).to.have.deep.property('results[0].name', 'lop');
        expect(result).to.have.deep.property('results[1].name', 'ripple');
    });

    it("should return empty Array", function(){
        expect(g.v({'lang':{$eq:'something'}}).emit().results).to.have.length(0);
    });
...
describe('e', function() {
    ...
    it("should return all vertices", function(){
        var result = g.e().emit();
        expect(result.results.length).to.equal(6);
        expect(result).to.have.deep.property('results[0]._id', 7);
    });
    ...
    it("should return empty Array", function(){
        expect(g.e({'lang':{$eq:'something'}}).emit().results).to.have.length(0);
    });

    // it("should NOT return a value if id not a edge id", function(){
    //     expect(g.e(1).emit()).to.throw(ReferenceError);
    // });
...
describe('v.out', function() {
    ...
    it("should get all out vertices", function(){
        ...
        expect(result.results.length).to.equal(6);
        expect(result).to.have.deep.property('results[0].name', 'vadas');
    });
...
describe('v.in', function() {
    ...
    it("should get all in vertices", function(){
        ...
        expect(result.results.length).to.equal(6);
        expect(result).to.have.deep.property('results[0].name', 'marko');
        expect(result).to.have.deep.property('results[1].name', 'marko');
    });
...
describe('v.both', function() {
    ...
    it("should get all out vertices", function(){
        ...
        expect(result.results.length).to.equal(12);
    });
...
describe('v.bothE.bothV', function() {
    ...
    it("should get all both vertices", function(){
        ...
        expect(result.results.length).to.equal(24);
    });
    ...
    it("should get both vertices from id 4", function(){
        expect(g.v(4).bothE().bothV().emit().results).to.have.length(6);
    });

    it("should return both vertices from id 1 & 4", function(){
        expect(g.v(1, 4).bothE().bothV().emit().results).to.have.length(12);
