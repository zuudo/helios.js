    ...
    (function (Mogwai) {
        ...
        var Pipeline = (function () {
            ...
            Pipeline.prototype.group = function (args) {
                var tracing = !!this.graph.traceEnabled, props = [], 
                    tempObj, tempProp, groupObj = {}, 
                    o = {}, outputObj = {}, element;
                args = Utils.flatten(args);
                ...
                this.endPipe = outputObj;
                return this;
            };
            Pipeline.prototype.sum = function (args) {
                var tracing = !!this.graph.traceEnabled, props = [], tempObj, tempProp, 
                    outputObj = { summed:{}, results: {} }, 
                    o = {}, isEmbedded = false;
                ...
                outputObj.summed = o3;
                outputObj.results = Utils.toObjArray(this.endPipe);
                this.endPipe = outputObj;
                return this;
            };
