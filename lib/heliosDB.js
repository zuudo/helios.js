...
(function (Helios) {
    ...
    (function (Mogwai) {
        ...
        var Compare = (function () {
            ...
            Compare.$includes = function $includes(objVal, val) {
            ...
            Compare.$excludes = function $excludes(objVal, val) {
            ...
            Compare.$every = function $every(objVal, val) {
            ...
            Compare.$matches = function $matches(objVal, val) {
                var matchCnt = 0, index = 0, i = 0, valLen = 0;
                val = Utils.unique(val);
                objVal = Utils.unique(objVal);
                valLen = val.length;
            ...
            Compare.$hasAll = function $hasAll(obj, val) {
                var i = val.length, matchCnt = 0, tempObj, tempProp;
                while(!!i) {
                    --i;
                    tempObj = obj;
                    tempProp = val[i];
