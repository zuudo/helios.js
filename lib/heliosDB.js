    ...
    (function (Mogwai) {
        ...
        var Compare = (function () {
            ...
            Compare.$eq = function $eq(objVal, val) {
                ...
                while(index) {
                    --index;
                    if(((Utils.isDate(val) && Utils.isDate(objVal[index])) || (Utils.isMoney(val) && Utils.isMoney(objVal[index])) || (Utils.isBoolean(val) && Utils.isBoolean(objVal[index])) || (!(Utils.isDate(objVal[index]) || Utils.isMoney(objVal[index]) || Utils.isBoolean(objVal[index])))) && (Utils.parseValue(objVal[index]) === Utils.parseValue(val))) {
                        return true;
                    }
                }
                return false;
            ...
            Compare.$in = function $in(objVal, val) {
                ...
                while(index) {
                    ...
                    while(!!i) {
                        --i;
                        if(((Utils.isDate(val[i]) && Utils.isDate(objVal[index])) || (Utils.isMoney(val[i]) && Utils.isMoney(objVal[index])) || (Utils.isBoolean(val[i]) && Utils.isBoolean(objVal[index])) || (!(Utils.isDate(objVal[index]) || Utils.isMoney(objVal[index]) || Utils.isBoolean(objVal[index])))) && (Utils.parseValue(objVal[index]) === Utils.parseValue(val[i]))) {
                            return true;
                        }
                    }
                }
