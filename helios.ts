...
//            }
    ...
    export module Mogwai{
        ...
        export class Pipeline implements IPipeline{
            ...
            private _add(func:string, ctx:Pipeline):()=>Pipeline{

                return function(...labels:string[]):Pipeline{
                    //var result;
                    if(func == 'emit'){
                        return ctx.prom.then(function () { return Q.fcall(ctx[func], ctx)});
                    }
                    if(!ctx.prom){
...
//                    console.log(result);
            ...
            private _out(labels:string[]):any {
            ...
            private _in(labels:string[], ctx):any {
                ...
                var value:{},
                    ...
                    endPipeArray:any[] = [],
                    hasArgs:bool = !!labels.length,
                    isTracing:bool = !!ctx.tracing,
                    traceArray:any[] = isTracing ? [] : undefined,
                    isTracingPath:bool = !!ctx.tracingPath,
                    pipes:any[],
                    pipe:IElement[];
                ...
                ctx.steps[++ctx.steps.currentStep] = { func: 'in', args: labels };
...
//             *****************************************************************************************************/
            ...
            emit(/*...props:string[]*/ctx:Pipeline):{ results:any[]; } {
