...
var ArrayProto = Array.prototype,
    ...
    _pipe = {},
    _pipedValue = [],
    _returnFuncs = ["value", "stringify", "map"];
...
Function.prototype.pipe = function() {
    ...
    return function() {
        ...
        var retVal = [];
        push.call(retVal, _pipedValue);

        _.each(arguments, function(arg){
            push.call(retVal ,arg);
        });
        _pipedValue = [];       
        _pipedValue = that.apply(this, retVal);
        return this;
    }
};
...
function pipe() {
    for (var fn in this) {
        if (typeof this[fn] == "function" && !_.include(_returnFuncs, fn)) {
            this[fn] = this[fn].pipe();
        }
    }
    return this;
}
...
function loadGraphJson(jsonData){
...
function map(){
	...
	!!args.length ? 
		retVal = _.map(_pipedValue, function(element){
			 params = [];
...
Helios.prototype.loadGraphJson = loadGraphJson;
